===Text Selection For Mobile===
Contributors: errnio
Donate link: 
Tags: mobile, search, text select, in site, index, site search, web search, monetization,  make money,
...
* **Mobile Search** - a simple and mobile enabled search box and text selection add-on for your site and domain.
...
1. errnio text select tool
2. Search box for mobile
